...
function  unlimited_posts_enqueue_custom_script()
{
    ...
    wp_enqueue_script('unlimited_posts_enqueue_custom_script-custom-script', plugins_url('display-unlimited-posts/assets/js/main.js'), array(), '1.0.5', true);
}
...
function unlimited_posts_enqueue_custom_style()
{
    ...
    wp_enqueue_style('unlimited_posts_enqueue_custom_script-custom-style', plugins_url('display-unlimited-posts/assets/css/main.css'), array(), '1.0.5', 'all');
}
